	...
	public NotificationChain basicSetColumnReference(ColumnReference newColumnReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					QueryPackage.SINGLE_COLUMN_WHAT_DIRECTIVE__COLUMN_REFERENCE, oldColumnReference,
					newColumnReference);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newColumnReference != columnReference) {
			...
			if (columnReference != null)
				msgs = ((InternalEObject) columnReference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QueryPackage.SINGLE_COLUMN_WHAT_DIRECTIVE__COLUMN_REFERENCE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					QueryPackage.SINGLE_COLUMN_WHAT_DIRECTIVE__COLUMN_REFERENCE, newColumnReference,
					newColumnReference));
	}
