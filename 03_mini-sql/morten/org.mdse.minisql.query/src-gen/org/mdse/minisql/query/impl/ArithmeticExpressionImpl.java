 ...
 *   <li>{@link org.mdse.minisql.query.impl.ArithmeticExpressionImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link org.mdse.minisql.query.impl.ArithmeticExpressionImpl#getExpression2 <em>Expression2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArithmeticExpressionImpl extends ExpressionImpl implements ArithmeticExpression {
	...
	public void setOperator(ArithmeticOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.ARITHMETIC_EXPRESSION__OPERATOR,
	...
	public NotificationChain basicSetExpression1(Expression newExpression1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					QueryPackage.ARITHMETIC_EXPRESSION__EXPRESSION1, oldExpression1, newExpression1);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression1 != expression1) {
			...
			if (expression1 != null)
				msgs = ((InternalEObject) expression1).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QueryPackage.ARITHMETIC_EXPRESSION__EXPRESSION1, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.ARITHMETIC_EXPRESSION__EXPRESSION1,
	...
	public NotificationChain basicSetExpression2(Expression newExpression2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					QueryPackage.ARITHMETIC_EXPRESSION__EXPRESSION2, oldExpression2, newExpression2);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newExpression2 != expression2) {
			...
			if (expression2 != null)
				msgs = ((InternalEObject) expression2).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QueryPackage.ARITHMETIC_EXPRESSION__EXPRESSION2, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.ARITHMETIC_EXPRESSION__EXPRESSION2,
