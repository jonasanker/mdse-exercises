 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.minisql.schema.impl.TableImpl#getColumn <em>Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends NamedElementImpl implements Table {
	...
	public EList<Column> getColumn() {
		if (column == null) {
			column = new EObjectContainmentEList<Column>(Column.class, this, SchemaPackage.TABLE__COLUMN);
		}
		return column;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SchemaPackage.TABLE__COLUMN:
