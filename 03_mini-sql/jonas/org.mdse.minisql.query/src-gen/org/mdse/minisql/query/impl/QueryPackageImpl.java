...
public class QueryPackageImpl extends EPackageImpl implements QueryPackage {
	 ...
	 */
	@Override
	public EReference getOrderByClause_OrderByDirectives() {
	...
	public EAttribute getOrderByDirective_Ascending() {
		return (EAttribute) orderByDirectiveEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getOrderByDirective_ColumnReference() {
		return (EReference) orderByDirectiveEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(orderByClauseEClass, ORDER_BY_CLAUSE__ORDER_BY_DIRECTIVES);
	...
	public void initializePackageContents() {
		...
		initEClass(whatClauseEClass, WhatClause.class, "WhatClause", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWhatClause_WhatDirectives(), this.getWhatDirective(), null, "whatDirectives", null, 1, -1,
		...
		initEClass(columnReferenceEClass, ColumnReference.class, "ColumnReference", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getColumnReference_Column(), theSchemaPackage.getColumn(), null, "column", null, 1, 1,
		...
		initEClass(orderByClauseEClass, OrderByClause.class, "OrderByClause", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOrderByClause_OrderByDirectives(), this.getOrderByDirective(), null, "orderByDirectives",
				null, 1, -1, OrderByClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
		...
		initEReference(getOrderByDirective_ColumnReference(), this.getColumnReference(), null, "columnReference", null,
				1, 1, OrderByDirective.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
