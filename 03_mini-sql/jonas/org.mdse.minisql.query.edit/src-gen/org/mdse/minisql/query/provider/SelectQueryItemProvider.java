...
public class SelectQueryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SelectQuery_from_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SelectQuery_from_feature",
								"_UI_SelectQuery_type"),
						QueryPackage.Literals.SELECT_QUERY__FROM, true, false, true, null, null, null));
	}
	...
	protected void addWhatPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SelectQuery_what_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SelectQuery_what_feature",
								"_UI_SelectQuery_type"),
						QueryPackage.Literals.SELECT_QUERY__WHAT, true, false, true, null, null, null));
	}
