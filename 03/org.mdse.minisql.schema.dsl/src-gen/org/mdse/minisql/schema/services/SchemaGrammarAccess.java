...
public class SchemaGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.mdse.minisql.schema.Schema.Table");
	...
	public class ColumnElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.mdse.minisql.schema.Schema.Column");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.mdse.minisql.schema.Schema".equals(grammar.getName())) {
				return grammar;
			}
