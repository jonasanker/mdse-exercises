...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setSource(State newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, FSMPackage.STATE__TRANSITIONS, State.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, FSMPackage.STATE__TRANSITIONS, State.class, msgs);
