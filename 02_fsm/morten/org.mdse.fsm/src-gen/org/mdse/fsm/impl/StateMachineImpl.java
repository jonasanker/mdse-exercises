...
public class StateMachineImpl extends NamedElementImpl implements StateMachine {
		...
		if (initial != null && initial.eIsProxy()) {
			...
			if (initial != oldInitial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.STATE_MACHINE__INITIAL,
							oldInitial, initial));
			}
		}
		return initial;
	...
	public void setInitial(State newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.STATE_MACHINE__INITIAL, oldInitial,
					initial));
	}
