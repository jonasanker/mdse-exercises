...
/**
 * This is the item provider adapter for a {@link org.mdse.fsm.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider extends NamedElementItemProvider {
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_StateMachine_initial_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_initial_feature",
								"_UI_StateMachine_type"),
						FsmPackage.Literals.STATE_MACHINE__INITIAL, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FsmPackage.Literals.STATE_MACHINE__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(FsmPackage.Literals.STATE_MACHINE__STATES, FsmFactory.eINSTANCE.createState()));
	}
