...
public class FSMPackageImpl extends EPackageImpl implements FSMPackage {
	...
	public void createPackageContents() {
		...
		createEReference(fsmModelEClass, FSM_MODEL__STATEMACHINES);
	...
	public void initializePackageContents() {
		...
		initEReference(getFSMModel_Statemachines(), this.getStateMachine(), null, "statemachines", null, 0, 1, FSMModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getState_IsFinal(), ecorePackage.getEBoolean(), "isFinal", "false", 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransition_Source(), this.getState(), this.getState_Transitions(), "source", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
